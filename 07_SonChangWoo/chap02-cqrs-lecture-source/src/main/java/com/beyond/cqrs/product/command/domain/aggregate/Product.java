...
public class Product {
  ...
  /* Product의 상태를 저장할 Enum 타입을 DB에 저장할 때 문자열로 저장하게 함 */
  ...
  (@NotBlank String productName, @Min(value = 1) Long productPrice,
   @NotBlank String productDescription, @Min(value = 1) Long categoryCode,
