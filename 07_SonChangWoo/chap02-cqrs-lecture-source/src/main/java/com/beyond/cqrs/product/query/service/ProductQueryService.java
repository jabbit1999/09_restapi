package com.beyond.cqrs.product.query.service;
...
import com.beyond.cqrs.product.query.dto.response.ProductDTO;
...
import com.beyond.cqrs.product.query.mapper.ProductMapper;
...
public class ProductQueryService {
  ...
  public ProductDetailResponse getProduct(Long productCode) {
    ...
    */
    ...
    /*
    Optional : null일 경우와 아닐 경우에 대한 동작 선택
    */
