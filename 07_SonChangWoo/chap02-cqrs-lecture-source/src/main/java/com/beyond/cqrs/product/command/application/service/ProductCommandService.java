package com.beyond.cqrs.product.command.application.service;

import com.beyond.cqrs.common.service.FileStorageService;
import com.beyond.cqrs.exception.BusinessException;
import com.beyond.cqrs.exception.ErrorCode;
...
import com.beyond.cqrs.product.command.domain.aggregate.ProductStatus;
...
public class ProductCommandService {
  ...
  public Long createProduct(
      ProductCreateRequest productCreateRequest, MultipartFile productImg) {
  ...
  public void deleteProduct(Long productCode) {
    ...
    * delete 메서도 호출 시 자동으로 update 구문이 수행된다.
    * */
