package com.beyond.restapi.section01.response;
...
public class ResponseController {
  ...
  /* 1.문자열 응답 */
  @GetMapping("/hello")
  // View Resolver를 찾아가지 않고, 응답 body에 담겨 그대로 클라이언트에게 응답
  ...
  public Message getMessage(){
    return new Message(200,"메시지를 응답 합니다.");
  }

  /* 3. List 응답 */
  @GetMapping("/list")
  public List<String> getList(){
    return List.of(new String[] {"딸기", "당근", "수박", "참외", "멜론"});
  }
  ...
  public byte[] getImage() throws IOException {
    return getClass()
        .getResourceAsStream("/images/weekly_menu.jpg")
        .readAllBytes();
  }
